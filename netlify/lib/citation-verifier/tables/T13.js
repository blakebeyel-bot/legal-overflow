/**
 * AUTO-GENERATED from T13.json — do not edit by hand.
 */
export default {
  "_meta": {
    "table": "T13",
    "rule": "BB R. 16",
    "title": "Periodical abbreviations",
    "edition": "22e",
    "scope": "Canonical abbreviations for legal periodicals (law reviews, journals, magazines). Used to validate citations to articles per R. 16.",
    "source": "Bluebook 22e Table T13",
    "note": "Seed entries cover the most-cited periodicals. Add more as the test corpus grows."
  },
  "periodicals": {
    "_top_general": "Most-cited general law reviews",
    ...
    "Colorado Law Review": "U. Colo. L. Rev.",
    "Denver Law Review": "Denv. L. Rev.",
    "Kansas Law Review": "U. Kan. L. Rev.",
    ...
    "_specialty_journals": "Specialty / topic-specific journals",
    ...
    "Stanford Environmental Law Journal": "Stan. Env't L.J.",
    ...
    "_bar_journals": "Bar journals & magazines",
    "American Bar Association Journal": "A.B.A. J.",
    "ABA Journal": "A.B.A. J.",
    "American Lawyer": "Am. Law.",
    "National Law Journal": "Nat'l L.J.",
    "Legal Times": "Legal Times",
    "Law360": "Law360",
    "Bloomberg Law": "Bloomberg L.",
    "New York Law Journal": "N.Y. L.J.",
    "Daily Journal": "Daily J.",
    "California Lawyer": "Cal. Law."
  },
  "common_words_in_periodical_names": {
    "Law Review": "L. Rev.",
    "Law Journal": "L.J.",
    "University": "U.",
    "Journal": "J.",
